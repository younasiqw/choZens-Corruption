			...
			{
				{
					...
					Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(159, 209, 20, MenuAlpha), Color(100, 0, 0, MenuAlpha9));
				}
			}
		...
		{
			{
				...
				Render::GradientV(a.x, a.y + 1, Location, 7, Color(159, 209, 20, MenuAlpha), Color(100, 0, 0, MenuAlpha9));
			}
		}
		else if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 1)
			if (Menu::Window.isOpen())
		...
		{
			{
				...
				Render::GradientV(a.x, a.y + 1, 7, Location, Color(159, 209, 20, MenuAlpha), Color(100, 0, 0, MenuAlpha9));
			}
		}
		else if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 1)
			if (Menu::Window.isOpen())
