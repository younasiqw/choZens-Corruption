...
#pragma region MPs
	...
	WeaponOtherFoV.SetBoundaries(0.f, 30.f);
...
#pragma region Other
	...
	OtherGroup.SetSize(240, 260);//500 is bottom js
...
//	OtherGroup.PlaceLabledControl("Slow Motion", this, &OtherSlowMotion);
	...
	KnifeGroup.SetPosition(16 + 85, 22+250+20+10);
	KnifeGroup.SetText("Knife Changer");
	KnifeGroup.SetSize(240, 100);
	...
	KnifeGroup.PlaceLabledControl("", this, &KnifeSkin);

	Gloves.SetPosition(16 + 85, 22 + 250 + 20+60 +60+10);
...
#pragma endregion
	...
	SkinApply.SetText("Force Update");
	SkinApply.SetCallback(GlovesApplyCallbk);
	SkinApply.SetPosition(279 + 85, 500);
