			...
			if (pLocal && pModelEntity && ChamsStyle != 0)
			{
				...
				if ((Menu::Window.VisualsTab.OptionsTeammates.GetState() || pModelEntity->GetTeamNum() != pLocal->GetTeamNum()))
				{
					...
					if (pModelEntity->IsAlive() && pModelEntity->GetHealth() > 0 /*&& pModelEntity->GetTeamNum() != local->GetTeamNum()*/)
					{
						...
						if (pModelEntity->GetTeamNum() != pLocal->GetTeamNum()) //   Team no vis
						{ 
							flColor[0] = 70.f / 255.f;  // t�ris
							flColor[1] = 120.f / 255.f;
							flColor[2] = 190.f / 255.f;
						}
						else													//   Team  vis
						{
							flColor[0] = 5.f / 255.f;    // gr�n
							flColor[1] = 55.f / 255.f;
							flColor[2] = 5.f / 255.f;
						}
						...
						if (pModelEntity->GetTeamNum() == pLocal->GetTeamNum())  //   Enemy no vis
						{

							flColor[0] = 60.f / 255.f;   // blau
							flColor[1] = 120.f / 255.f;
							flColor[2] = 180.f / 255.f;
						}
						else 													//   Enemy vis
						{
							flColor[0] = 150.f / 255.f;  // gelb
